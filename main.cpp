...
int main()
{
    ...
    unordered_map<string, NonTerminal*> namesNonTerminalsMap = cfg.get_non_terminals_map();

    
    pair<vector<string>, unordered_map<string, NonTerminal *>> nonTerminals = make_pair(nonTerminalsNames, namesNonTerminalsMap);
    calculateFirstToCFG(nonTerminals);
